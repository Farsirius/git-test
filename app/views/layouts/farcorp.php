...
<div class="super_container">
	...
	<header class="header">
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			...
			<!-- Navigation -->
			<nav class="header_nav top_nav">
                        <?php 
                            new \app\widgets\menu\Menu(['tpl' => WWW.'/menu/menu.php','table' => 'main_menu','containerProps' => ' class="d-flex flex-row align-items-center justify-content-start"']);
                        ?>
	...
	<div class="menu d-flex flex-column align-items-start justify-content-start menu_mm trans_400">
		...
		<nav class="menu_nav">
                    <?php 
                        new \app\widgets\menu\Menu(['tpl' => WWW.'/menu/menu.php','table' => 'main_menu']);
                    ?>
                    <!--<ul class="menu_mm">
	...
	<div class="sidebar">
		...
		<div class="info">
			<div class="info_content d-flex flex-row align-items-center justify-content-start">
				...
				<!-- Currency -->
				<div id="currency" class="info_currencies has_children">
